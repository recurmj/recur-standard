...
/// @title RecurPull — Minimal Permissioned-Pull Primitive (RIP-001 Reference)
/// @notice Canonical minimal implementation of the permissioned-pull standard (RIP-001).
/// @dev
/// - A grantor signs an Authorization (EIP-712).
/// - The grantee can call pull() within that scope (amount / time window / receiver).
/// - The grantor can revoke by hash at any time.
/// - No custody, scheduling, or external registry.
///
/// This file is intentionally minimal so others can audit, fork,
/// or extend with registries and budgets (RIP-002).
/// For stricter production patterns see RecurPullSafeV2.sol and RIP-002.
interface IERC20 {
