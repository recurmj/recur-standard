# RIP-002: Consent Registry & Events (Optional Index)
...
RIP-002 defines a minimal, optional **Consent Registry & Events** interface for all *Authorization Objects* (RIP-100), including the financial permissioned-pull model described in RIP-001. 
